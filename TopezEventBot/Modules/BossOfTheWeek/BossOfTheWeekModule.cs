...
{
    public BossOfTheWeekModule(IDbContextFactory<TopezContext> contextFactory, IRunescapeHiscoreHttpClient rsClient) : base(contextFactory, rsClient, TrackableEventType.BossOfTheWeek)
    {
    }
